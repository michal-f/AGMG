        ...
        vc_map( array(
            ...
            "params"                        => array(
				...
				/*array(
                    ...
                    "value"                 => array(
                        __("YouTube", "ts_visual_composer_extend")                  => "qtip-youtube",
                        __("Bootstrap", "ts_visual_composer_extend")				=> "qtip-bootstrap",
                        __("Tipsy", "ts_visual_composer_extend")                   	=> "qtip-tipsy",
						__("jTools", "ts_visual_composer_extend")                  	=> "qtip-jtools",
						__("ClueTip", "ts_visual_composer_extend")                  => "qtip-cluetip",
						__("Tipped", "ts_visual_composer_extend")                  	=> "qtip-tipped",
                        __("Default", "ts_visual_composer_extend")					=> "",
                        __("Plain", "ts_visual_composer_extend")                   	=> "qtip-plain",
                        __("Light", "ts_visual_composer_extend")                  	=> "qtip-light",
                        __("Dark", "ts_visual_composer_extend")                   	=> "qtip-dark",
                        __("Red", "ts_visual_composer_extend")                    	=> "qtip-red",
                        __("Green", "ts_visual_composer_extend")                 	=> "qtip-green",
                        __("Blue", "ts_visual_composer_extend")                 	=> "qtip-blue",
                    ),
