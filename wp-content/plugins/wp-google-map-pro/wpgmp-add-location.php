...
<div class="form-horizontal">
    ...
    <div class="row">    	
    <div class="col-md-2"><label for="title"><?php _e('Address', 'wpgmp_google_map')?>&nbsp;</label></div>
    <div class="col-md-7">
  ...
  <div class="row">         
  <div class="col-md-2">  <label for="title"><?php _e('Choose Marker Image', 'wpgmp_google_map')?></label></div>
