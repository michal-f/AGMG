        ...
        vc_map( array(
            ...
            "params"                    => array(
                ...
                array(
                    ...
                    "admin_label"       => true,
                    "description"       => __( "Select the icon for your icon title.", "ts_visual_composer_extend" ),
                ...
                array(
                    ...
                    "description"       => __( "Select the shadow effect for the icon title.", "ts_visual_composer_extend" ),
                    "dependency"        => array( 'element' => "animations", 'value' => 'true' ),
					"group" 			=> "Other Settings",
                ),
                array(
