...
/**
 * 
 * TimThumb WP Multisite ready by Luca Montanari
 * http://codecanyon.net/user/LCweb?ref=LCweb
 *
...
//////////////////////////////////////////////////////////////////////
// MULTISITE FIX (part 1 of 3) (2 at line #827) (3 at line #876)
...
class timthumb {
	...
	public function __construct(){
		...
		if($this->isURL){
			...
			if(! $this->localImage){
				...
				$this->error("docRoot: {$this->docRoot}"); // know the docRoot path
				$this->set404();
				return false;
			}
	...
	protected function serveInternalImage(){
		...
		if(isset($_GET['lc-debug'])) {echo 'Final image path: '.$this->localImage.'<br/><br/>';} // lcweb debug
	...
	protected function calcDocRoot(){
		...
		/////////////////////////////////////////////////////////
		// MULTISITE FIX by (part 2 of 3) (1 at line #143) (3 at line #876)
		if (is_multisite()){
