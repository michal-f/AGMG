...
?>
	<div class="ts-vcsc-custom-upload-wrap wrap" style="width: 100%;">
		...
		<a class="button-secondary" style="width: 200px; margin: 15px auto 10px auto; text-align: center;" href="<?php echo $this->settingsLink; ?>" target="_parent"><img src="<?php echo TS_VCSC_GetResourceURL('images/logos/ts_vcsc_menu_icon_16x16.png'); ?>" style="width: 16px; height: 16px; margin-right: 10px;">Back to Plugin Settings</a>
		...
		<form id="ts_vcsc_icons_upload_custom_pack_form" enctype="multipart/form-data" action="" method="POST">
			<div id="ts-vcsc-async-upload-wrap" class="clearFixMe" style="margin-bottom:0;">
				...
				<div style="width:100%; display: block;">
					...
					<?php if (file_exists($dest_path . '/ts-vcsc-custom-pack.zip')) { ?>
				...
				<div class="ts-vcsc-custom-pack-buttons">
					<div style="float: left;">
						<?php
							echo submit_button('Import', 'primary', 'Submit', false, ''); 
						?>
					</div>
