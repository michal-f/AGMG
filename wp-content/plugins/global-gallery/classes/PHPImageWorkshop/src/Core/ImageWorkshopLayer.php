...
require_once(GG_DIR . '/classes/PHPImageWorkshop/src/ImageWorkshop.php');
require_once(GG_DIR . '/classes/PHPImageWorkshop/src/Core/ImageWorkshopLib.php');
require_once(GG_DIR . '/classes/PHPImageWorkshop/src/Core/Exception/ImageWorkshopLayerException.php');
