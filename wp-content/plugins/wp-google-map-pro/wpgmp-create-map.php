   ...
   jQuery(document).ready(function($){
    ...
    ?>
        ...
        ?>
            ...
            {
            ?>
                    <input type="checkbox" name="locations[]" class="wpgmp-location-checkbox" checked="checked" value="<?php echo $results[$i]->location_id; ?>"/>
                    &nbsp;&nbsp;
                    <?php 
...
?>
          ...
          <fieldset>
            ...
            <?php if(empty($_POST['direction_servics']['specific_routes'])) { ?>
...
?>            
          ...
          <fieldset>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="title">
                  <?php _e('Display Marker Category', 'wpgmp_google_map')?>
                </label>
              </div>
              <div class="col-md-7">
              	<p class="description">
                	<input type="checkbox" name="control[display_marker_category]" class="marker_category_toggle" value="true" <?php if( !empty($_POST['control']['display_marker_category']) ) { checked($_POST['control']['display_marker_category'],'true'); } ?> />
                  	<?php _e('Display categories/locations on the map.', 'wpgmp_google_map')?>
                </p>
              </div>
            </div>
	 ...
	 <div class="row">	
						<div class="col-md-3"><label for="wpgmp_direction_tab"><?php _e( 'Display Directions Tab', 'wpgmp_google_map' ) ?></label></div>
							<div class="col-md-7">
								...
								<input type="checkbox" name="control[wpgmp_direction_tab]"  value="true" <?php if( !empty($_POST['control']['wpgmp_direction_tab']) ) { checked($_POST['control']['wpgmp_direction_tab'],'true'); } ?> />
