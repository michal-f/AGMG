 ...
 * @return string HTML
 */
if ( ! function_exists( 'pt_fa_shortcode' ) ) {
	function pt_fa_shortcode( $atts ) {
	...
	add_shortcode( 'fa', 'pt_fa_shortcode' );
}
 ...
 * @return string HTML
 */
if ( ! function_exists( 'pt_button_shortcode' ) ) {
	function pt_button_shortcode( $atts , $content = '' ) {
		extract( shortcode_atts( array(
			'style'  => 'primary',
			'href'   => '#',
			'target' => '_self',
	...
	add_shortcode( 'button', 'pt_button_shortcode' );
}