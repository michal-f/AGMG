...
(function (window, $, undefined) {
            ...
            "<div class='sp-container sp-hidden'>",
                ...
                "<div class='sp-picker-container'>",
                    ...
                    "<div class='sp-button-container sp-cf'>",
                        "<span class='dslca-sp-revert dslc-icon dslc-icon-undo' title='Revert to default'></span>",
                        "<span class='sp-cancel dslc-icon dslc-icon-remove' title='Cancel'></span>",
                        "<span class='sp-choose dslc-icon dslc-icon-ok' title='Confirm'></span>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    function spectrum(element, o) {
        ...
        function revert() {
            ...
            boundElement.trigger('change', [ colorOnShow ]);
        }
